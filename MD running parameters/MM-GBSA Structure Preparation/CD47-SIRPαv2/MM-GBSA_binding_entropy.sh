...
mpirun -np 5 MMPBSA.py.MPI -O -i mmgbsa.in -o FINAL_RESULTS_MMGBSA.dat -sp sys_sol.prmtop -cp dry.prmtop -rp sirpa.prmtop -lp CD47.prmtop -y ../../md/500ns/pr*.nc > mmgbsa_process.log